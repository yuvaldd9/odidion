...
class client:
    ...
    UDP_IP = '192.168.0.100'#'10.0.0.7'#'192.168.1.22' #'192.168.43.207' #'10.0.0.5'
    UDP_PORT = 50101
    UDP_ADDR = (UDP_IP, UDP_PORT)

    FIRST_TIME = True

    DIR_SERVER_IP = '192.168.0.100'#'192.168.1.22' #'192.168.43.207' #'10.0.0.5'
